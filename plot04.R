...
global_reactive_power <- as.numeric(cons_data_sub$Global_reactive_power)
voltage <- as.numeric(cons_data_sub$Voltage)
...
dev.copy(png, file = "plot04.png", height = 480, width = 480)
dev.off()
